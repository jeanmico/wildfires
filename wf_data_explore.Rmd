...
# expand this to loop through all factors in our dataframe
df = births
fact_cols=c("hispanic_OSHPD", "black_OSHPD", "asian_OSHPD", "other_race_OSHPD")

fact_name = 'race'
fact_default = 'White'

df[fact_name]=fact_default

for(colname in fact_cols)({
  coldata=df[,colname]
  df[[fact_name]][which(coldata==1)]=colname
})
